...
public class MaterialDivider extends View {
    ...
    public MaterialDivider(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.f523materialDividerStyle);
    }
    ...
    public MaterialDivider(android.content.Context r8, android.util.AttributeSet r9, int r10) {
        /*
            ...
            int r3 = com.google.android.material.R.dimen.f1444material_divider_thickness
    ...
    public void onDraw(Canvas canvas) {
        ...
        boolean z2 = z;
        this.dividerDrawable.setBounds(z2 ? this.insetEnd : this.insetStart, 0, getWidth() - (z2 ? this.insetStart : this.insetEnd), getBottom() - getTop());
