...
class MaterialButtonHelper {
    ...
    private Drawable createBackground() {
        ...
        materialShapeDrawable2.setStroke((float) this.strokeWidth, this.shouldDrawSurfaceColorStroke ? MaterialColors.getColor(this.materialButton, R.attr.f320colorSurface) : 0);
        if (IS_MIN_LOLLIPOP) {
    ...
    private MaterialShapeDrawable getMaterialShapeDrawable(boolean getSurfaceColorStrokeDrawable) {
        ...
        return IS_MIN_LOLLIPOP ? (MaterialShapeDrawable) ((LayerDrawable) ((InsetDrawable) this.rippleDrawable.getDrawable(0)).getDrawable()).getDrawable(getSurfaceColorStrokeDrawable ^ true ? 1 : 0) : (MaterialShapeDrawable) this.rippleDrawable.getDrawable(getSurfaceColorStrokeDrawable ^ true ? 1 : 0);
    }
    ...
    private void setVerticalInsets(int newInsetTop, int newInsetBottom) {
        ...
        ViewCompat.setPaddingRelative(this.materialButton, paddingStart, (paddingTop + newInsetTop) - i, paddingEnd, (paddingBottom + newInsetBottom) - i2);
    }
    ...
    private void updateStroke() {
        ...
        if (materialShapeDrawable != null) {
            ...
            if (surfaceColorStrokeDrawable != null) {
                surfaceColorStrokeDrawable.setStroke((float) this.strokeWidth, this.shouldDrawSurfaceColorStroke ? MaterialColors.getColor(this.materialButton, R.attr.f320colorSurface) : 0);
            }
        }
    }
