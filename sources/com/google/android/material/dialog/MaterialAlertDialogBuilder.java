...
public class MaterialAlertDialogBuilder extends AlertDialog.Builder {
    ...
    private static final int DEF_STYLE_RES = R.style.f2200MaterialAlertDialog_MaterialComponents;
    private static final int MATERIAL_ALERT_DIALOG_THEME_OVERLAY = R.attr.f493materialAlertDialogTheme;
    ...
    public MaterialAlertDialogBuilder(Context context, int overrideThemeResId) {
        ...
        int color = MaterialColors.getColor(context2, R.attr.f320colorSurface, getClass().getCanonicalName());
