...
public class BadgeDrawable extends Drawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    private static final int DEFAULT_STYLE = R.style.f2668Widget_MaterialComponents_Badge;
    private static final int DEFAULT_THEME_ATTR = R.attr.f213badgeStyle;
    ...
    private BadgeDrawable(Context context, int badgeResId, int defStyleAttr, int defStyleRes, BadgeState.State savedState) {
        ...
        setTextAppearanceResource(R.style.f2319TextAppearance_MaterialComponents_Badge);
    ...
    private void calculateCenterAndBounds(Context context, Rect anchorRect, View anchorView) {
        ...
        int dimensionPixelSize = context.getResources().getDimensionPixelSize(hasNumber() ? R.dimen.f1477mtrl_badge_text_horizontal_edge_offset : R.dimen.f1474mtrl_badge_horizontal_edge_offset);
    ...
    private String getBadgeText() {
        ...
        String format = String.format(this.state.getNumberLocale(), context.getString(R.string.f2046mtrl_exceed_max_badge_number_suffix), new Object[]{Integer.valueOf(this.maxBadgeNumber), DEFAULT_EXCEED_MAX_BADGE_NUMBER_SUFFIX});
    ...
    private void tryWrapAnchorInCompatParent(final View anchorView) {
        ...
        if (viewGroup == null || viewGroup.getId() != R.id.f1800mtrl_anchor_parent) {
            ...
            if (weakReference == null || weakReference.get() != viewGroup) {
                ...
                frameLayout.setId(R.id.f1800mtrl_anchor_parent);
