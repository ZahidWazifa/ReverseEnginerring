...
public class FabTransformationSheetBehavior extends FabTransformationBehavior {
    ...
    private void updateImportantForAccessibility(View sheet, boolean expanded) {
        ...
        if (parent instanceof CoordinatorLayout) {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                boolean z = (childAt.getLayoutParams() instanceof CoordinatorLayout.LayoutParams) && (((CoordinatorLayout.LayoutParams) childAt.getLayoutParams()).getBehavior() instanceof FabTransformationScrimBehavior);
                if (childAt != sheet && !z) {
                    if (!expanded) {
    ...
    public FabTransformationBehavior.FabTransformationSpec onCreateMotionSpec(Context context, boolean expanded) {
        int i = expanded ? R.animator.f202mtrl_fab_transformation_sheet_expand_spec : R.animator.f201mtrl_fab_transformation_sheet_collapse_spec;
