...
public class MaterialCheckBox extends AppCompatCheckBox {
    private static final int DEF_STYLE_RES = R.style.f2701Widget_MaterialComponents_CompoundButton_CheckBox;
    ...
    private ColorStateList getMaterialThemeColorsTintList() {
        if (this.materialThemeColorsTintList == null) {
            ...
            int color2 = MaterialColors.getColor(this, R.attr.f320colorSurface);
