...
public abstract class NavigationBarItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public NavigationBarItemView(Context context) {
        ...
        this.iconContainer = (FrameLayout) findViewById(R.id.f1824navigation_bar_item_icon_container);
        this.activeIndicatorView = findViewById(R.id.f1823navigation_bar_item_active_indicator_view);
        ImageView imageView = (ImageView) findViewById(R.id.f1825navigation_bar_item_icon_view);
        this.icon = imageView;
        ViewGroup viewGroup = (ViewGroup) findViewById(R.id.f1826navigation_bar_item_labels_group);
        this.labelGroup = viewGroup;
        TextView textView = (TextView) findViewById(R.id.f1828navigation_bar_item_small_label_view);
        this.smallLabel = textView;
        TextView textView2 = (TextView) findViewById(R.id.f1827navigation_bar_item_large_label_view);
    ...
    private void maybeAnimateActiveIndicatorToProgress(final float newProgress) {
        ...
        this.activeIndicatorAnimator.setInterpolator(MotionUtils.resolveThemeInterpolator(getContext(), R.attr.f546motionEasingStandard, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR));
        this.activeIndicatorAnimator.setDuration((long) MotionUtils.resolveThemeDuration(getContext(), R.attr.f536motionDurationLong1, getResources().getInteger(R.integer.f1891material_motion_duration_long_1)));
    ...
    public int getItemBackgroundResId() {
        return R.drawable.f1715mtrl_navigation_bar_item_background;
    }
    ...
    public int getItemDefaultMarginResId() {
        return R.dimen.f1597mtrl_navigation_bar_item_default_margin;
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        wrap.setRoleDescription(getResources().getString(R.string.f2006item_view_role_description));
    }
