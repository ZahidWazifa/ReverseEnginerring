...
public abstract class NavigationBarMenuView extends ViewGroup implements MenuView {
    ...
    public NavigationBarMenuView(Context context) {
        ...
        if (isInEditMode()) {
            ...
            autoTransition.setDuration((long) MotionUtils.resolveThemeDuration(getContext(), R.attr.f536motionDurationLong1, getResources().getInteger(R.integer.f1891material_motion_duration_long_1)));
            autoTransition.setInterpolator(MotionUtils.resolveThemeInterpolator(getContext(), R.attr.f546motionEasingStandard, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR));
