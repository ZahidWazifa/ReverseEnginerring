...
public class MaterialColors {
    ...
    public static ColorRoles getColorRoles(int color, boolean isLightTheme) {
        return isLightTheme ? new ColorRoles(getColorRole(color, 40), getColorRole(color, 100), getColorRole(color, 90), getColorRole(color, 10)) : new ColorRoles(getColorRole(color, 80), getColorRole(color, 20), getColorRole(color, 30), getColorRole(color, 90));
    }
