...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable, MaterialCheckable<Chip> {
    ...
    private static final int DEF_STYLE_RES = R.style.f2692Widget_MaterialComponents_Chip_Action;
        ...
        public void onPopulateNodeForVirtualView(int virtualViewId, AccessibilityNodeInfoCompat node) {
            ...
            if (virtualViewId == 1) {
                ...
                if (closeIconContentDescription != null) {
                    ...
                    int i = R.string.f2044mtrl_chip_close_icon_content_description;
    ...
    public Chip(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.f274chipStyle);
    }
