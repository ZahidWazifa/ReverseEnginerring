...
public class ChipGroup extends FlowLayout {
    private static final int DEF_STYLE_RES = R.style.f2691Widget_MaterialComponents_ChipGroup;
    ...
    public ChipGroup(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.f259chipGroupStyle);
    }
