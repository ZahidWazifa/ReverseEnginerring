...
public final class MaterialCalendar<S> extends PickerFragment<S> {
    ...
    private void addActionsToMonthNavigation(View root, final MonthsPagerAdapter monthsPagerAdapter) {
        final MaterialButton materialButton = (MaterialButton) root.findViewById(R.id.f1796month_navigation_fragment_toggle);
        ...
        ViewCompat.setAccessibilityDelegate(materialButton, new AccessibilityDelegateCompat() {
            public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                ...
                accessibilityNodeInfoCompat.setHintText(MaterialCalendar.this.dayFrame.getVisibility() == 0 ? MaterialCalendar.this.getString(R.string.f2077mtrl_picker_toggle_to_year_selection) : MaterialCalendar.this.getString(R.string.f2075mtrl_picker_toggle_to_day_selection));
            }
        });
        MaterialButton materialButton2 = (MaterialButton) root.findViewById(R.id.f1798month_navigation_previous);
        materialButton2.setTag(NAVIGATION_PREV_TAG);
        MaterialButton materialButton3 = (MaterialButton) root.findViewById(R.id.f1797month_navigation_next);
        materialButton3.setTag(NAVIGATION_NEXT_TAG);
        this.yearFrame = root.findViewById(R.id.f1808mtrl_calendar_year_selector_frame);
        this.dayFrame = root.findViewById(R.id.f1801mtrl_calendar_day_selector_frame);
    ...
    static int getDayHeight(Context context) {
        return context.getResources().getDimensionPixelSize(R.dimen.f1518mtrl_calendar_day_height);
    }

    private static int getDialogPickerHeight(Context context) {
        Resources resources = context.getResources();
        int dimensionPixelSize = resources.getDimensionPixelSize(R.dimen.f1539mtrl_calendar_navigation_height) + resources.getDimensionPixelOffset(R.dimen.f1540mtrl_calendar_navigation_top_padding) + resources.getDimensionPixelOffset(R.dimen.f1538mtrl_calendar_navigation_bottom_padding);
        int dimensionPixelSize2 = resources.getDimensionPixelSize(R.dimen.f1523mtrl_calendar_days_of_week_height);
        return dimensionPixelSize + dimensionPixelSize2 + (MonthAdapter.MAXIMUM_WEEKS * resources.getDimensionPixelSize(R.dimen.f1518mtrl_calendar_day_height)) + ((MonthAdapter.MAXIMUM_WEEKS - 1) * resources.getDimensionPixelOffset(R.dimen.f1537mtrl_calendar_month_vertical_padding)) + resources.getDimensionPixelOffset(R.dimen.f1515mtrl_calendar_bottom_padding);
    }
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (MaterialDatePicker.isFullscreen(contextThemeWrapper)) {
            i2 = R.layout.f1962mtrl_calendar_vertical;
            i = 1;
        } else {
            i2 = R.layout.f1957mtrl_calendar_horizontal;
            i = 0;
        }
        View inflate = cloneInContext.inflate(i2, viewGroup, false);
        inflate.setMinimumHeight(getDialogPickerHeight(requireContext()));
        GridView gridView = (GridView) inflate.findViewById(R.id.f1802mtrl_calendar_days_of_week);
        ...
        this.recyclerView = (RecyclerView) inflate.findViewById(R.id.f1805mtrl_calendar_months);
        ...
        int integer = contextThemeWrapper.getResources().getInteger(R.integer.f1903mtrl_calendar_year_selector_span);
        RecyclerView recyclerView2 = (RecyclerView) inflate.findViewById(R.id.f1808mtrl_calendar_year_selector_frame);
        ...
        if (inflate.findViewById(R.id.f1796month_navigation_fragment_toggle) != null) {
