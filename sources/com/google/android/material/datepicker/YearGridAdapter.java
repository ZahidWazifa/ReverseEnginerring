...
class YearGridAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int position) {
        ...
        String string = viewHolder.textView.getContext().getString(R.string.f2060mtrl_picker_navigate_to_year_description);
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        return new ViewHolder((TextView) LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.f1963mtrl_calendar_year, viewGroup, false));
    }
}
