...
class UtcDates {
    ...
    static java.text.DateFormat getMediumNoYear(Locale locale) {
        ...
        Log3FA212.a((Object) removeYearFromDateFormatPattern);
        LogEB28DF.a((Object) removeYearFromDateFormatPattern);
        Log390828.a((Object) removeYearFromDateFormatPattern);
        Log952E92.a((Object) removeYearFromDateFormatPattern);
    ...
    static String getTextInputHint(Resources res, SimpleDateFormat format) {
        ...
        String string = res.getString(R.string.f2073mtrl_picker_text_input_year_abbr);
        String string2 = res.getString(R.string.f2072mtrl_picker_text_input_month_abbr);
        String string3 = res.getString(R.string.f2071mtrl_picker_text_input_day_abbr);
