...
public class RangeDateSelector implements DateSelector<Pair<Long, Long>> {
    ...
    public int getDefaultThemeResId(Context context) {
        ...
        return MaterialAttributes.resolveOrThrow(context, Math.min(displayMetrics.widthPixels, displayMetrics.heightPixels) > resources.getDimensionPixelSize(R.dimen.f1535mtrl_calendar_maximum_default_fullscreen_minor_axis) ? R.attr.f513materialCalendarTheme : R.attr.f502materialCalendarFullscreenTheme, MaterialDatePicker.class.getCanonicalName());
    }

    public int getDefaultTitleResId() {
        return R.string.f2065mtrl_picker_range_header_title;
    }
    ...
    public String getSelectionDisplayString(Context context) {
        ...
        if (l == null && this.selectedEndItem == null) {
            return resources.getString(R.string.f2066mtrl_picker_range_header_unselected);
        }
        Long l2 = this.selectedEndItem;
        if (l2 == null) {
            int i = R.string.f2063mtrl_picker_range_header_only_start_selected;
            ...
            int i2 = R.string.f2062mtrl_picker_range_header_only_end_selected;
            ...
            return resources.getString(R.string.f2064mtrl_picker_range_header_selected, new Object[]{dateRangeString.first, dateRangeString.second});
        }
    }
    ...
    public View onCreateTextInputView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle, CalendarConstraints constraints, OnSelectionChangedListener<Pair<Long, Long>> onSelectionChangedListener) {
        View inflate = layoutInflater.inflate(R.layout.f1976mtrl_picker_text_input_date_range, viewGroup, false);
        TextInputLayout textInputLayout = (TextInputLayout) inflate.findViewById(R.id.f1820mtrl_picker_text_input_range_start);
        TextInputLayout textInputLayout2 = (TextInputLayout) inflate.findViewById(R.id.f1819mtrl_picker_text_input_range_end);
        ...
        this.invalidRangeStartError = inflate.getResources().getString(R.string.f2059mtrl_picker_invalid_range);
        ...
        Log3FA212.a((Object) textInputHint);
        LogEB28DF.a((Object) textInputHint);
        Log390828.a((Object) textInputHint);
        Log952E92.a((Object) textInputHint);
