...
public class MaterialStyledDatePickerDialog extends DatePickerDialog {
    ...
    private static final int DEF_STYLE_RES = R.style.f2203MaterialAlertDialog_MaterialComponents_Picker_Date_Spinner;
    ...
    public MaterialStyledDatePickerDialog(Context context, int themeResId, DatePickerDialog.OnDateSetListener listener, int year, int monthOfYear, int dayOfMonth) {
        ...
        int resolveOrThrow = MaterialAttributes.resolveOrThrow(getContext(), R.attr.f320colorSurface, getClass().getCanonicalName());
        int i = DEF_STYLE_RES;
