...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    private static Drawable createHeaderToggleDrawable(Context context) {
        ...
        stateListDrawable.addState(new int[]{16842912}, AppCompatResources.getDrawable(context, R.drawable.f1700material_ic_calendar_black_24dp));
        stateListDrawable.addState(new int[0], AppCompatResources.getDrawable(context, R.drawable.f1702material_ic_edit_black_24dp));
        return stateListDrawable;
    }

    private void enableEdgeToEdgeIfNeeded(Window window) {
        if (!this.edgeToEdgeEnabled) {
            final View findViewById = requireView().findViewById(R.id.f1766fullscreen_header);
    ...
    private static int getPaddedPickerWidth(Context context) {
        ...
        int dimensionPixelOffset = resources.getDimensionPixelOffset(R.dimen.f1516mtrl_calendar_content_padding);
        int i = Month.current().daysInWeek;
        return (dimensionPixelOffset * 2) + (i * resources.getDimensionPixelSize(R.dimen.f1522mtrl_calendar_day_width)) + ((i - 1) * resources.getDimensionPixelOffset(R.dimen.f1536mtrl_calendar_month_horizontal_padding));
    }
    ...
    static boolean isNestedScrollable(Context context) {
        return readMaterialCalendarStyleBoolean(context, R.attr.f551nestedScrollable);
    }
    ...
    static boolean readMaterialCalendarStyleBoolean(Context context, int attributeResId) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(MaterialAttributes.resolveOrThrow(context, R.attr.f512materialCalendarStyle, MaterialCalendar.class.getCanonicalName()), new int[]{attributeResId});
    ...
    public void startPickerFragment() {
        ...
        beginTransaction.replace(R.id.f1803mtrl_calendar_frame, this.pickerFragment);
    ...
    public void updateHeader() {
        ...
        String format = String.format(getString(R.string.f2049mtrl_picker_announce_current_selection), new Object[]{headerText});
    ...
    public void updateToggleContentDescription(CheckableImageButton toggle) {
        this.headerToggleButton.setContentDescription(this.headerToggleButton.isChecked() ? toggle.getContext().getString(R.string.f2074mtrl_picker_toggle_to_calendar_input_mode) : toggle.getContext().getString(R.string.f2076mtrl_picker_toggle_to_text_input_mode));
    }
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        ...
        int resolveOrThrow = MaterialAttributes.resolveOrThrow(context, R.attr.f320colorSurface, MaterialDatePicker.class.getCanonicalName());
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(context, (AttributeSet) null, R.attr.f512materialCalendarStyle, R.style.f2710Widget_MaterialComponents_MaterialCalendar);
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View inflate = layoutInflater.inflate(this.fullscreen ? R.layout.f1969mtrl_picker_fullscreen : R.layout.f1968mtrl_picker_dialog, viewGroup);
        Context context = inflate.getContext();
        if (this.fullscreen) {
            inflate.findViewById(R.id.f1803mtrl_calendar_frame).setLayoutParams(new LinearLayout.LayoutParams(getPaddedPickerWidth(context), -2));
        } else {
            inflate.findViewById(R.id.f1804mtrl_calendar_main_pane).setLayoutParams(new LinearLayout.LayoutParams(getPaddedPickerWidth(context), -1));
        }
        TextView textView = (TextView) inflate.findViewById(R.id.f1815mtrl_picker_header_selection_text);
        this.headerSelectionText = textView;
        ViewCompat.setAccessibilityLiveRegion(textView, 1);
        this.headerToggleButton = (CheckableImageButton) inflate.findViewById(R.id.f1817mtrl_picker_header_toggle);
        TextView textView2 = (TextView) inflate.findViewById(R.id.f1821mtrl_picker_title_text);
        ...
        this.confirmButton = (Button) inflate.findViewById(R.id.f1737confirm_button);
        ...
        Button button = (Button) inflate.findViewById(R.id.f1726cancel_button);
    ...
    public void onStart() {
        ...
        if (this.fullscreen) {
            ...
            int dimensionPixelOffset = getResources().getDimensionPixelOffset(R.dimen.f1524mtrl_calendar_dialog_background_inset);
