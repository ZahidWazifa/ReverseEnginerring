...
public class ElevationOverlayProvider {
    ...
    public ElevationOverlayProvider(Context context) {
        this(MaterialAttributes.resolveBoolean(context, R.attr.f357elevationOverlayEnabled, false), MaterialColors.getColor(context, R.attr.f356elevationOverlayColor, 0), MaterialColors.getColor(context, R.attr.f355elevationOverlayAccentColor, 0), MaterialColors.getColor(context, R.attr.f320colorSurface, 0), context.getResources().getDisplayMetrics().density);
    }
