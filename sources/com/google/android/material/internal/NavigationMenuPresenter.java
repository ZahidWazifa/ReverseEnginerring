...
public class NavigationMenuPresenter implements MenuPresenter {
    ...
    private static class NormalViewHolder extends ViewHolder {
        public NormalViewHolder(LayoutInflater inflater, ViewGroup parent, View.OnClickListener listener) {
            super(inflater.inflate(R.layout.f1921design_navigation_item, parent, false));
    ...
    private static class SeparatorViewHolder extends ViewHolder {
        public SeparatorViewHolder(LayoutInflater inflater, ViewGroup parent) {
            super(inflater.inflate(R.layout.f1923design_navigation_item_separator, parent, false));
        }
    }

    private static class SubheaderViewHolder extends ViewHolder {
        public SubheaderViewHolder(LayoutInflater inflater, ViewGroup parent) {
            super(inflater.inflate(R.layout.f1924design_navigation_item_subheader, parent, false));
        }
    }
    ...
    public MenuView getMenuView(ViewGroup root) {
        if (this.menuView == null) {
            NavigationMenuView navigationMenuView = (NavigationMenuView) this.layoutInflater.inflate(R.layout.f1925design_navigation_menu, root, false);
            ...
            this.headerLayout = (LinearLayout) this.layoutInflater.inflate(R.layout.f1922design_navigation_item_header, this.menuView, false);
    ...
    public void initForMenu(Context context, MenuBuilder menu2) {
        ...
        this.menu = menu2;
        this.paddingSeparator = context.getResources().getDimensionPixelOffset(R.dimen.f1253design_navigation_separator_vertical_padding);
    }
