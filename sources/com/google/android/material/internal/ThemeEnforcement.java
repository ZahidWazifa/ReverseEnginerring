...
public final class ThemeEnforcement {
    ...
    private static final int[] MATERIAL_CHECK_ATTRS = {R.attr.f316colorPrimaryVariant};
    ...
    private static void checkCompatibleTheme(Context context, AttributeSet set, int defStyleAttr, int defStyleRes) {
        ...
        if (z) {
            ...
            if (!context.getTheme().resolveAttribute(R.attr.f442isMaterialTheme, typedValue, true) || (typedValue.type == 18 && typedValue.data == 0)) {
