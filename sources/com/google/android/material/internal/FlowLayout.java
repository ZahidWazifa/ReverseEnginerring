...
public class FlowLayout extends ViewGroup {
    ...
    public int getRowIndex(View child) {
        Object tag = child.getTag(R.id.f1837row_index_key);
    ...
    public void onLayout(boolean sizeChanged, int left, int top, int right, int bottom) {
        ...
        while (i5 < getChildCount()) {
            ...
            if (childAt.getVisibility() == 8) {
                childAt.setTag(R.id.f1837row_index_key, -1);
                i = paddingRight;
            } else {
                ...
                i = paddingRight;
                childAt.setTag(R.id.f1837row_index_key, Integer.valueOf(this.rowCount - 1));
