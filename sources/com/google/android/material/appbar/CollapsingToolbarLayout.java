...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    private static final int DEF_STYLE_RES = R.style.f2512Widget_Design_CollapsingToolbar;
    ...
    public CollapsingToolbarLayout(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.f295collapsingToolbarLayoutStyle);
    }
    ...
    public CollapsingToolbarLayout(android.content.Context r11, android.util.AttributeSet r12, int r13) {
        ...
        L_0x00a6:
            ...
            r10.setTitle(r1)
            int r1 = com.google.android.material.R.style.f2275TextAppearance_Design_CollapsingToolbar_Expanded
    ...
    static ViewOffsetHelper getViewOffsetHelper(View view) {
        ViewOffsetHelper viewOffsetHelper = (ViewOffsetHelper) view.getTag(R.id.f1862view_offset_helper);
        if (viewOffsetHelper != null) {
            return viewOffsetHelper;
        }
        ViewOffsetHelper viewOffsetHelper2 = new ViewOffsetHelper(view);
        view.setTag(R.id.f1862view_offset_helper, viewOffsetHelper2);
    ...
    public void setTitleCollapseMode(int titleCollapseMode2) {
        ...
        if (isTitleCollapseFadeMode && this.contentScrim == null) {
            setContentScrimColor(this.elevationOverlayProvider.compositeOverlayWithThemeSurfaceColorIfNeeded(getResources().getDimension(R.dimen.f1222design_appbar_elevation)));
        }
    }
