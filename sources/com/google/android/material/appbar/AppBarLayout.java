...
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.AttachedBehavior {
    private static final int DEF_STYLE_RES = R.style.f2509Widget_Design_AppBarLayout;
    ...
    public AppBarLayout(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.f204appBarLayoutStyle);
    }
    ...
    private void startLiftOnScrollElevationOverlayAnimation(final MaterialShapeDrawable background, boolean lifted2) {
        float dimension = getResources().getDimension(R.dimen.f1222design_appbar_elevation);
        float f = 0.0f;
        ...
        ofFloat.setDuration((long) getResources().getInteger(R.integer.MT_Bin));
    ...
    public int[] onCreateDrawableState(int extraSpace) {
        ...
        iArr[0] = this.liftable ? R.attr.f602state_liftable : -R.attr.f602state_liftable;
        iArr[1] = (!this.liftable || !this.lifted) ? -R.attr.f603state_lifted : R.attr.f603state_lifted;
        iArr[2] = this.liftable ? R.attr.f600state_collapsible : -R.attr.f600state_collapsible;
        iArr[3] = (!this.liftable || !this.lifted) ? -R.attr.f599state_collapsed : R.attr.f599state_collapsed;
