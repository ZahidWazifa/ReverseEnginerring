...
public class MaterialRadioButton extends AppCompatRadioButton {
    private static final int DEF_STYLE_RES = R.style.f2702Widget_MaterialComponents_CompoundButton_RadioButton;
    ...
    private ColorStateList getMaterialThemeColorsTintList() {
        if (this.materialThemeColorsTintList == null) {
            ...
            int color2 = MaterialColors.getColor(this, R.attr.f307colorOnSurface);
            int color3 = MaterialColors.getColor(this, R.attr.f320colorSurface);
