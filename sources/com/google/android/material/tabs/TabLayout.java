...
public class TabLayout extends HorizontalScrollView {
    ...
    private static final int DEF_STYLE_RES = R.style.f2517Widget_Design_TabLayout;
    ...
    public final class TabView extends LinearLayout {
        ...
        private void inflateAndAddDefaultIconView() {
            ...
            ImageView imageView = (ImageView) LayoutInflater.from(getContext()).inflate(R.layout.f1918design_layout_tab_icon, viewGroup, false);
        ...
        private void inflateAndAddDefaultTextView() {
            ...
            TextView textView2 = (TextView) LayoutInflater.from(getContext()).inflate(R.layout.f1919design_layout_tab_text, viewGroup, false);
    ...
    public TabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.f640tabStyle);
    }
    ...
    public TabLayout(android.content.Context r11, android.util.AttributeSet r12, int r13) {
        ...
        L_0x0084:
            ...
            int r2 = com.google.android.material.R.style.f2285TextAppearance_Design_Tab
        ...
        L_0x013f:
            ...
            int r3 = com.google.android.material.R.dimen.f1268design_tab_text_size_2line
            int r3 = r2.getDimensionPixelSize(r3)
            float r3 = (float) r3
            r10.tabTextMultiLineSize = r3
            int r3 = com.google.android.material.R.dimen.f1266design_tab_scrollable_min_width
            int r3 = r2.getDimensionPixelSize(r3)
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (View.MeasureSpec.getMode(widthMeasureSpec) != 0) {
            ...
            if (i <= 0) {
                i = (int) (((float) size) - ViewUtils.dpToPx(getContext(), 56));
            }
            this.tabMaxWidth = i;
        }
        super.onMeasure(widthMeasureSpec, heightMeasureSpec);
