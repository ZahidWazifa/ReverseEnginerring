...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    private static final int[] SNACKBAR_STYLE_ATTR = {R.attr.f592snackbarStyle};
    ...
    protected static class SnackbarBaseLayout extends FrameLayout {
        ...
        private Drawable createThemedBackground() {
            float dimension = getResources().getDimension(R.dimen.f1641mtrl_snackbar_background_corner_radius);
            GradientDrawable gradientDrawable = new GradientDrawable();
            gradientDrawable.setShape(0);
            gradientDrawable.setCornerRadius(dimension);
            gradientDrawable.setColor(MaterialColors.layer(this, R.attr.f320colorSurface, R.attr.f307colorOnSurface, getBackgroundOverlayColorAlpha()));
            ...
            public void run() {
                ...
                if (BaseTransientBottomBar.this.view != null && BaseTransientBottomBar.this.context != null && (access$100 = (BaseTransientBottomBar.this.getScreenHeight() - BaseTransientBottomBar.this.getViewAbsoluteBottom()) + ((int) BaseTransientBottomBar.this.view.getTranslationY())) < BaseTransientBottomBar.this.extraBottomMarginGestureInset) {
                    ...
                    if (!(layoutParams instanceof ViewGroup.MarginLayoutParams)) {
                        ...
                        Log3FA212.a((Object) access$400);
                        LogEB28DF.a((Object) access$400);
                        Log390828.a((Object) access$400);
                        Log952E92.a((Object) access$400);
    ...
    public int getSnackbarBaseLayoutResId() {
        return hasSnackbarStyleAttr() ? R.layout.f1964mtrl_layout_snackbar : R.layout.f1916design_layout_snackbar;
    }
