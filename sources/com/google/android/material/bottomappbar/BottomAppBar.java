...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.AttachedBehavior {
    ...
    private static final int DEF_STYLE_RES = R.style.f2669Widget_MaterialComponents_BottomAppBar;
        ...
        private final View.OnLayoutChangeListener fabLayoutListener = new View.OnLayoutChangeListener() {
            public void onLayoutChange(View v, int left, int top, int right, int bottom, int oldLeft, int oldTop, int oldRight, int oldBottom) {
                ...
                if (Behavior.this.originalBottomMargin == 0) {
                    layoutParams.bottomMargin = bottomAppBar.getBottomInset() + (bottomAppBar.getResources().getDimensionPixelOffset(R.dimen.f1483mtrl_bottomappbar_fab_bottom_margin) - ((floatingActionButton.getMeasuredHeight() - height) / 2));
            ...
            if (access$3100 != null && !ViewCompat.isLaidOut(access$3100)) {
                ...
                if (access$3100 instanceof FloatingActionButton) {
                    ...
                    if (floatingActionButton.getShowMotionSpec() == null) {
                        floatingActionButton.setShowMotionSpecResource(R.animator.f200mtrl_fab_show_motion_spec);
                    }
                    if (floatingActionButton.getHideMotionSpec() == null) {
                        floatingActionButton.setHideMotionSpecResource(R.animator.f199mtrl_fab_hide_motion_spec);
                    }
    ...
    public BottomAppBar(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.f229bottomAppBarStyle);
    }
    ...
    public BottomAppBar(android.content.Context r12, android.util.AttributeSet r13, int r14) {
        ...
        L_0x0050:
            ...
            int r9 = com.google.android.material.R.dimen.f1482mtrl_bottomappbar_fabOffsetEndMode
