...
public final class LinearProgressIndicatorSpec extends BaseProgressIndicatorSpec {
    ...
    public LinearProgressIndicatorSpec(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.f484linearProgressIndicatorStyle);
    }
    ...
    public LinearProgressIndicatorSpec(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        boolean z = false;
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attrs, R.styleable.LinearProgressIndicator, R.attr.f484linearProgressIndicatorStyle, LinearProgressIndicator.DEF_STYLE_RES, new int[0]);
