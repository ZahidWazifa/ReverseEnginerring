...
public final class CircularProgressIndicatorSpec extends BaseProgressIndicatorSpec {
    ...
    public CircularProgressIndicatorSpec(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.f276circularProgressIndicatorStyle);
    }
    ...
    public CircularProgressIndicatorSpec(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        int dimensionPixelSize = context.getResources().getDimensionPixelSize(R.dimen.f1620mtrl_progress_circular_size_medium);
        int dimensionPixelSize2 = context.getResources().getDimensionPixelSize(R.dimen.f1615mtrl_progress_circular_inset_medium);
