...
public abstract class BaseProgressIndicatorSpec {
    ...
    protected BaseProgressIndicatorSpec(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        int dimensionPixelSize = context.getResources().getDimensionPixelSize(R.dimen.f1626mtrl_progress_track_thickness);
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attrs, R.styleable.BaseProgressIndicator, defStyleAttr, defStyleRes, new int[0]);
