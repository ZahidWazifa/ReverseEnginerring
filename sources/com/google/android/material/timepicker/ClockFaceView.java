...
class ClockFaceView extends RadialViewGroup implements ClockHandView.OnRotateListener {
    ...
    public ClockFaceView(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.f520materialClockStyle);
    }
    ...
    public ClockFaceView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attrs, R.styleable.ClockFaceView, defStyleAttr, R.style.f2768Widget_MaterialComponents_TimePicker_Clock);
        ...
        LayoutInflater.from(context).inflate(R.layout.f1939material_clockface_view, this, true);
        ClockHandView clockHandView2 = (ClockHandView) findViewById(R.id.f1775material_clock_hand);
        this.clockHandView = clockHandView2;
        this.clockHandPadding = resources.getDimensionPixelSize(R.dimen.f1433material_clock_hand_padding);
        ...
        int defaultColor = AppCompatResources.getColorStateList(context, R.color.f1162material_timepicker_clockface).getDefaultColor();
        ...
        this.valueAccessibilityDelegate = new AccessibilityDelegateCompat() {
            public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
                ...
                int intValue = ((Integer) host.getTag(R.id.f1791material_value_index)).intValue();
                if (intValue > 0) {
        ...
        Arrays.fill(strArr, "");
        setValues(strArr, 0);
        this.minimumHeight = resources.getDimensionPixelSize(R.dimen.f1466material_time_picker_minimum_screen_height);
        this.minimumWidth = resources.getDimensionPixelSize(R.dimen.f1467material_time_picker_minimum_screen_width);
        this.clockSize = resources.getDimensionPixelSize(R.dimen.f1440material_clock_size);
    }
    ...
    private void updateTextViews(int r9) {
        ...
        L_0x002e:
            ...
            int r5 = com.google.android.material.R.layout.f1938material_clockface_textview
        ...
        L_0x0042:
            ...
            r5 = r5[r2]
            r3.setText(r5)
            int r5 = com.google.android.material.R.id.f1791material_value_index
