...
class ClockHandView extends View {
    ...
    public ClockHandView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attrs, R.styleable.ClockHandView, defStyleAttr, R.style.f2768Widget_MaterialComponents_TimePicker_Clock);
        ...
        this.selectorStrokeWidth = resources.getDimensionPixelSize(R.dimen.f1434material_clock_hand_stroke_width);
        this.centerDotRadius = (float) resources.getDimensionPixelSize(R.dimen.f1432material_clock_hand_center_dot_radius);
