...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    private static class EdgeToEdgeCallback extends BottomSheetBehavior.BottomSheetCallback {
        ...
        private EdgeToEdgeCallback(View bottomSheet, WindowInsetsCompat insetsCompat2) {
            ...
            MaterialShapeDrawable materialShapeDrawable = BottomSheetBehavior.from(bottomSheet).getMaterialShapeDrawable();
            ColorStateList fillColor = materialShapeDrawable != null ? materialShapeDrawable.getFillColor() : ViewCompat.getBackgroundTintList(bottomSheet);
            if (fillColor != null) {
    ...
    public BottomSheetDialog(Context context) {
        this(context, 0);
        this.edgeToEdgeEnabled = getContext().getTheme().obtainStyledAttributes(new int[]{R.attr.f358enableEdgeToEdge}).getBoolean(0, false);
    }
    ...
    private FrameLayout ensureContainerAndBehavior() {
        if (this.container == null) {
            FrameLayout frameLayout = (FrameLayout) View.inflate(getContext(), R.layout.f1915design_bottom_sheet_dialog, (ViewGroup) null);
            this.container = frameLayout;
            this.coordinator = (CoordinatorLayout) frameLayout.findViewById(R.id.f1740coordinator);
            FrameLayout frameLayout2 = (FrameLayout) this.container.findViewById(R.id.f1744design_bottom_sheet);
    ...
    private static int getThemeResId(Context context, int themeId) {
        ...
        return context.getTheme().resolveAttribute(R.attr.f232bottomSheetDialogTheme, typedValue, true) ? typedValue.resourceId : R.style.f2433Theme_Design_Light_BottomSheetDialog;
    }

    public static void setLightStatusBar(View view, boolean isLight) {
        if (Build.VERSION.SDK_INT >= 23) {
            int systemUiVisibility = view.getSystemUiVisibility();
            view.setSystemUiVisibility(isLight ? systemUiVisibility | 8192 : systemUiVisibility & -8193);
        }
    }

    private View wrapInBottomSheet(int layoutResId, View view, ViewGroup.LayoutParams params) {
        ensureContainerAndBehavior();
        CoordinatorLayout coordinatorLayout = (CoordinatorLayout) this.container.findViewById(R.id.f1740coordinator);
        ...
        coordinatorLayout.findViewById(R.id.f1860touch_outside).setOnClickListener(new View.OnClickListener() {
