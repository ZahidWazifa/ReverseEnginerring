...
public class FloatingActionButton extends VisibilityAwareImageButton implements TintableBackgroundView, TintableImageSourceView, ExpandableTransformationWidget, Shapeable, CoordinatorLayout.AttachedBehavior {
    ...
    private static final int DEF_STYLE_RES = R.style.f2513Widget_Design_FloatingActionButton;
    ...
    public FloatingActionButton(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.f406floatingActionButtonStyle);
    }
    ...
    public FloatingActionButton(android.content.Context r17, android.util.AttributeSet r18, int r19) {
        /*
            ...
            int r6 = com.google.android.material.R.dimen.f1583mtrl_fab_min_touch_target
    ...
    private int getSizeDimension(int size2) {
        ...
        switch (size2) {
            ...
            case 1:
                return resources.getDimensionPixelSize(R.dimen.f1241design_fab_size_mini);
            default:
                return resources.getDimensionPixelSize(R.dimen.f1242design_fab_size_normal);
        }
    }
