...
public class MaterialCardView extends CardView implements Checkable, Shapeable {
    ...
    private static final int DEF_STYLE_RES = R.style.f2689Widget_MaterialComponents_CardView;
    private static final int[] DRAGGED_STATE_SET = {R.attr.f601state_dragged};
    ...
    public MaterialCardView(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.f518materialCardViewStyle);
    }
