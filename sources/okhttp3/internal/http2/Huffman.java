...
public final class Huffman {
    ...
    private final void addCode(int symbol, int code, int codeBitCount) {
        ...
        ArraysKt.fill((T[]) children2, node, i4, i4 + (1 << i3));
    }
    ...
    public final void decode(BufferedSource source, long byteCount, BufferedSink sink) {
        ...
        int i = 0;
        int i2 = 0;
        for (long j = 0; j < byteCount; j = 1 + j) {
            i = (i << 8) | Util.and(source.readByte(), 255);
            i2 += 8;
            while (i2 >= 8) {
                Node[] children = node.getChildren();
                Intrinsics.checkNotNull(children);
                Node node2 = children[(i >>> (i2 - 8)) & 255];
        ...
        while (i2 > 0) {
            ...
            Intrinsics.checkNotNull(children2);
            Node node3 = children2[(i << (8 - i2)) & 255];
            Intrinsics.checkNotNull(node3);
            Node node4 = node3;
            if (node4.getChildren() == null && node4.getTerminalBitCount() <= i2) {
                sink.writeByte(node4.getSymbol());
                i2 -= node4.getTerminalBitCount();
                node = root;
            } else {
                return;
            }
