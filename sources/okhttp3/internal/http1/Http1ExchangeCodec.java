...
public final class Http1ExchangeCodec implements ExchangeCodec {
    ...
    private final class ChunkedSource extends AbstractSource {
        ...
        public ChunkedSource(Http1ExchangeCodec this$02, HttpUrl url2) {
            super();
    ...
    public Http1ExchangeCodec(OkHttpClient client2, RealConnection connection2, BufferedSource source2, BufferedSink sink2) {
        ...
        this.source = source2;
        this.sink = sink2;
        this.headersReader = new HeadersReader(source2);
    }
    ...
    private final boolean isChunked(Response $this$isChunked) {
        String header$default = Response.header$default($this$isChunked, "Transfer-Encoding", (String) null, 2, (Object) null);
