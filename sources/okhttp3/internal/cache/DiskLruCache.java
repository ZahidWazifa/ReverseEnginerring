...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    private final void readJournal() throws java.io.IOException {
        /*
            ...
            r3 = r1
            okio.BufferedSource r3 = (okio.BufferedSource) r3     // Catch:{ all -> 0x00ed }
            r4 = 0
            java.lang.String r5 = r3.readUtf8LineStrict()     // Catch:{ all -> 0x00ed }
            java.lang.String r6 = r3.readUtf8LineStrict()     // Catch:{ all -> 0x00ed }
            java.lang.String r7 = r3.readUtf8LineStrict()     // Catch:{ all -> 0x00ed }
            java.lang.String r8 = r3.readUtf8LineStrict()     // Catch:{ all -> 0x00ed }
            java.lang.String r9 = r3.readUtf8LineStrict()     // Catch:{ all -> 0x00ed }
            java.lang.String r10 = MAGIC     // Catch:{ all -> 0x00ed }
            boolean r10 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r10, (java.lang.Object) r5)     // Catch:{ all -> 0x00ed }
            r11 = 1
            r10 = r10 ^ r11
            if (r10 != 0) goto L_0x00b3
            java.lang.String r10 = VERSION_1     // Catch:{ all -> 0x00ed }
            boolean r10 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r10, (java.lang.Object) r6)     // Catch:{ all -> 0x00ed }
            r10 = r10 ^ r11
            if (r10 != 0) goto L_0x00b3
            int r10 = r12.appVersion     // Catch:{ all -> 0x00ed }
            java.lang.String r10 = java.lang.String.valueOf(r10)     // Catch:{ all -> 0x00ed }
            mt.Log3FA212.a((java.lang.Object) r10)
            mt.LogEB28DF.a((java.lang.Object) r10)
            mt.Log390828.a((java.lang.Object) r10)
            mt.Log952E92.a((java.lang.Object) r10)
            boolean r10 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r10, (java.lang.Object) r7)     // Catch:{ all -> 0x00ed }
            r10 = r10 ^ r11
            if (r10 != 0) goto L_0x00b3
            int r10 = r12.valueCount     // Catch:{ all -> 0x00ed }
            java.lang.String r10 = java.lang.String.valueOf(r10)     // Catch:{ all -> 0x00ed }
            mt.Log3FA212.a((java.lang.Object) r10)
            mt.LogEB28DF.a((java.lang.Object) r10)
            mt.Log390828.a((java.lang.Object) r10)
            mt.Log952E92.a((java.lang.Object) r10)
            boolean r10 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r10, (java.lang.Object) r8)     // Catch:{ all -> 0x00ed }
            r10 = r10 ^ r11
            if (r10 != 0) goto L_0x00b3
            r10 = r9
            java.lang.CharSequence r10 = (java.lang.CharSequence) r10     // Catch:{ all -> 0x00ed }
            int r10 = r10.length()     // Catch:{ all -> 0x00ed }
        ...
        L_0x0080:
            ...
            r0 = 0
        L_0x0083:
            java.lang.String r10 = r3.readUtf8LineStrict()     // Catch:{ EOFException -> 0x008f }
            r12.readJournalLine(r10)     // Catch:{ EOFException -> 0x008f }
            int r0 = r0 + 1
            goto L_0x0083
        L_0x008f:
            r10 = move-exception
            java.util.LinkedHashMap<java.lang.String, okhttp3.internal.cache.DiskLruCache$Entry> r10 = r12.lruEntries     // Catch:{ all -> 0x00ed }
            int r10 = r10.size()     // Catch:{ all -> 0x00ed }
            int r10 = r0 - r10
            r12.redundantOpCount = r10     // Catch:{ all -> 0x00ed }
            boolean r10 = r3.exhausted()     // Catch:{ all -> 0x00ed }
            if (r10 != 0) goto L_0x00a5
            r12.rebuildJournal$okhttp()     // Catch:{ all -> 0x00ed }
            goto L_0x00ab
        L_0x00a5:
            okio.BufferedSink r10 = r12.newJournalWriter()     // Catch:{ all -> 0x00ed }
            r12.journalWriter = r10     // Catch:{ all -> 0x00ed }
        L_0x00ab:
            kotlin.Unit r0 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x00ed }
            kotlin.io.CloseableKt.closeFinally(r1, r2)
            return
        L_0x00b3:
            java.io.IOException r2 = new java.io.IOException     // Catch:{ all -> 0x00ed }
            java.lang.StringBuilder r10 = new java.lang.StringBuilder     // Catch:{ all -> 0x00ed }
            r10.<init>()     // Catch:{ all -> 0x00ed }
            java.lang.String r11 = "unexpected journal header: ["
            java.lang.StringBuilder r10 = r10.append(r11)     // Catch:{ all -> 0x00ed }
            java.lang.StringBuilder r10 = r10.append(r5)     // Catch:{ all -> 0x00ed }
            java.lang.StringBuilder r10 = r10.append(r0)     // Catch:{ all -> 0x00ed }
            java.lang.StringBuilder r10 = r10.append(r6)     // Catch:{ all -> 0x00ed }
            java.lang.StringBuilder r10 = r10.append(r0)     // Catch:{ all -> 0x00ed }
            java.lang.StringBuilder r10 = r10.append(r8)     // Catch:{ all -> 0x00ed }
            java.lang.StringBuilder r0 = r10.append(r0)     // Catch:{ all -> 0x00ed }
            java.lang.StringBuilder r0 = r0.append(r9)     // Catch:{ all -> 0x00ed }
            r10 = 93
            java.lang.StringBuilder r0 = r0.append(r10)     // Catch:{ all -> 0x00ed }
            java.lang.String r0 = r0.toString()     // Catch:{ all -> 0x00ed }
            r2.<init>(r0)     // Catch:{ all -> 0x00ed }
            java.lang.Throwable r2 = (java.lang.Throwable) r2     // Catch:{ all -> 0x00ed }
