...
public class AndroidSocketAdapter implements SocketAdapter {
    ...
    public static final class Companion {
        ...
        public final AndroidSocketAdapter build(Class<? super SSLSocket> actualSSLSocketClass) {
            ...
            while (cls != null && (!Intrinsics.areEqual((Object) cls.getSimpleName(), (Object) "OpenSSLSocketImpl"))) {
        ...
        public final DeferredSocketAdapter.Factory factory(String packageName) {
    ...
    public AndroidSocketAdapter(Class<? super SSLSocket> sslSocketClass2) {
        Intrinsics.checkNotNullParameter(sslSocketClass2, "sslSocketClass");
        this.sslSocketClass = sslSocketClass2;
        Method declaredMethod = sslSocketClass2.getDeclaredMethod("setUseSessionTickets", new Class[]{Boolean.TYPE});
        Intrinsics.checkNotNullExpressionValue(declaredMethod, "sslSocketClass.getDeclar…:class.javaPrimitiveType)");
        this.setUseSessionTickets = declaredMethod;
        this.setHostname = sslSocketClass2.getMethod("setHostname", new Class[]{String.class});
        this.getAlpnSelectedProtocol = sslSocketClass2.getMethod("getAlpnSelectedProtocol", new Class[0]);
        this.setAlpnProtocols = sslSocketClass2.getMethod("setAlpnProtocols", new Class[]{byte[].class});
    }
