...
public final class Headers implements Iterable<Pair<? extends String, ? extends String>>, KMappedMarker {
    ...
    public static final class Companion {
        ...
        public final Headers m1639deprecated_of(Map<String, String> headers) {
            Intrinsics.checkNotNullParameter(headers, "headers");
            return of(headers);
        }
        ...
        /* renamed from: -deprecated_of  reason: not valid java name */
        public final Headers m1640deprecated_of(String... namesAndValues) {
        ...
        public final Headers of(Map<String, String> $this$toHeaders) {
            ...
            String[] strArr = new String[($this$toHeaders.size() * 2)];
            int i = 0;
        ...
        public final Headers of(String... namesAndValues) {
            ...
            if (namesAndValues.length % 2 == 0) {
                ...
                if (clone != null) {
                    ...
                    IntProgression step = RangesKt.step((IntProgression) RangesKt.until(0, strArr.length), 2);
                    int first = step.getFirst();
                    int last = step.getLast();
                    int step2 = step.getStep();
    ...
    public final int m1638deprecated_size() {
        return size();
    }
    ...
    public final String get(String name) {
        Intrinsics.checkNotNullParameter(name, "name");
        String access$get = Companion.get(this.namesAndValues, name);
        Log3FA212.a((Object) access$get);
        LogEB28DF.a((Object) access$get);
        Log390828.a((Object) access$get);
        Log952E92.a((Object) access$get);
        return access$get;
    }
